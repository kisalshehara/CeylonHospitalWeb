(function($) {
	...
	if($('.mobile-menu').length){
		...
		// Assuming you are using mCustomScrollbar for custom scrollbar
		// $('.mobile-menu .menu-box').mCustomScrollbar();
		
		// Retrieve and append the main menu content
		var mobileMenuContent = $('.main-header .nav-outer .main-menu').html();
		$('.mobile-menu .menu-box .menu-outer').append(mobileMenuContent);
		$('.sticky-header .main-menu').append(mobileMenuContent);
		
		// Append a new <li> item to the mobile menu
		var newMenuItem = '<li><a href="https://portal.ceylonhospital.com">Login</a></li>';
		$('.mobile-menu .menu-box .menu-outer').append(newMenuItem);
...
var btn = document.getElementById("open-lightbox");
...
btn.onclick = function(event) {
    ...
    document.getElementById("lightbox-iframe").src = "/ai"; // Replace with your URL
...
span.onclick = function() {
    ...
    setTimeout(function() {
        ...
        document.getElementById("lightbox-iframe").src = "/ai"; // Clear the iframe src
...
window.onclick = function(event) {
    if (event.target == lightbox) {
        ...
        setTimeout(function() {
            lightbox.style.display = "none";
            document.getElementById("lightbox-iframe").src = ""; // Clear the iframe src
        }, 500); // Wait for the animation to finish
    }
}
...
document.querySelector('.chat-lightbox .close').addEventListener('click', function () {
